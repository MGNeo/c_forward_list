...
**c_forward_list** - контейнер, бестиповый односвязный список. Различные узлы одного и того же **c_forward_list** могут содержать данные различных типов и размеров.
